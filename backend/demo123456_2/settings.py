"""
Django settings for demo123456_2 project.
...
ROOT_URLCONF = 'demo123456_2.urls'
...
WSGI_APPLICATION = 'demo123456_2.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "demo123456 Support <support@demo123456-2.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demo123456_2 API",
    "DESCRIPTION": "API documentation for demo123456_2 App",
    "VERSION": "v1",
}
...
if AS_BUCKET_NAME:
    ...
    DEFAULT_FILE_STORAGE = "demo123456_2.storage_backends.AzureMediaStorage"
    STATICFILES_STORAGE = "demo123456_2.storage_backends.AzureStaticStorage"
